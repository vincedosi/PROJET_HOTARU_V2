...
RELEASE_NOTE = "Backoffice tabs + CRUD workspaces. Fix scraping 1er clic. Comparaison JSON-LD (gris/vert/rouge). Prompt Mistral visible. Traitement en masse avec validation nœud par nœud. Delta Supabase."
